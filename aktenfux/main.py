...
def split_document(doc_id: str, split_markers: list[int], config: AktenfuxConfig) -> list[str]:
    ...
    *split_markers* are 1-based page numbers at which a new segment begins
    ...
    # Convert 1-based page markers to 0-based page indices for pypdf.
    ...
    # Resolve the GUI overlay path before moving the original (pdf_path will no
    # longer exist at its _Review location after move_file_with_sidecar).
